...
func TestDiagnostics(t *testing.T) {
	...
	t.Run("CleanFile", func(t *testing.T) {
		...
		result, err := tools.GetDiagnosticsForFile(ctx, suite.Client, filePath, 2, true, -1, tools.DiagnosticFilter{})
		if err != nil {
...
`
	...
	t.Run("FileDependency", func(t *testing.T) {
		...
		result, err := tools.GetDiagnosticsForFile(ctx, suite.Client, consumerPath, 2, true, -1, tools.DiagnosticFilter{})
		if err != nil {
			t.Fatalf("GetDiagnosticsForFile failed: %v", err)
		}
